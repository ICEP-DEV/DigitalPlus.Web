...
const VideoLandingPage = () => {
  ...
  useEffect(() => {
    const imageInterval = setInterval(() => {
      ...
      setCurrentImage((prevImage) => (prevImage === master ? picture1 : master));
      ...
      >
        ...
        <div className={styles.aboutContent}>
          ...
          <div className={styles.aboutParagraph}>
            ...
            <p>We recognize the challenges that can arise in mentorship relationships, such as scheduling conflicts, communication barriers, and goal tracking. To overcome these, our platform provides user-friendly tools for organizing meetings, setting milestones, and facilitating effective communication. By streamlining these processes, we empower mentors to focus on providing guidance and mentees to maximize their learning experience.</p>
          </div>
        </div>
          ...
          <img
            src={currentImage}
            alt="About Us"
            className={`${styles.aboutImage} ${animateSlide ? styles['slide-in'] : ''}`}  // Apply slide-in class conditionally
          />
        </div>
      </div>
      ...
      >
        ...
        <div className={styles.missionContent}>
          ...
          <div className={styles.missionParagraph}>
            <p>
            Our mission is to create a supportive and transparent environment where mentors can 
effectively guide mentee , and mentee can easily access the assistance they need.
We aim to empower both parties by providing the resources and systems necessary 
        ...
        <div className={styles.coreValuesContent}>
          ...
          <div className={styles.coreValueContainer}>
            <div className={styles.coreValueCard}>
              ...
              in all our processes. Our 
              digital notification system 
              ensures that key possession 
              and mentor availability are 
            ...
            <div className={styles.coreValueCard}>
              ...
              support they need. Our mentor 
              profile system and real-time
              location tracking ensure that 
              students can quickly and
              effortlessly find the right 
              mentor for their needs.
              </p>
            </div>
            <div className={styles.coreValueCard}>
              <h3 className={styles.coreValueHeading}>COLLABORATION</h3>
              <p className={styles.coreValueParagraph}>
              We value the power of teamwork
                and cooperation. Our system
                fosters a collaborative 
                environment where students 
                and mentors work together 
      ...
      >
        ...
        <div className={styles.servicesContent}>
          ...
          <div className={styles.servicesParagraph}>
            ...
            <p>
              Mentor's Performance Evaluation
            </p>
            </li>
          </div>
        </div>
